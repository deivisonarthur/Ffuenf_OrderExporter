...
/**
 * @see Ffuenf_OrderExporter_Helper_Data
 *
 * @loadSharedFixture shared
 */
class Ffuenf_OrderExporter_Test_Helper_Data extends EcomDev_PHPUnit_Test_Case
{
    /**
     * @var Ffuenf_OrderExporter_Helper_Data
     */
    protected $_helper;

    public function setUp()
    {
        $this->_helper = new Ffuenf_OrderExporter_Helper_Data();
    }
     ...
     *
     * @test
     * @covers Ffuenf_OrderExporter_Helper_Data::isExtensionActive
     */
     ...
     *
     * @test
     * @covers Ffuenf_OrderExporter_Helper_Data::isLogActive
     */
     ...
     *
     * @test
     * @covers Ffuenf_OrderExporter_Helper_Data::isLogProfileActive
     */
     ...
     *
     * @test
     * @covers Ffuenf_OrderExporter_Helper_Data::isLogExceptionActive
     */
